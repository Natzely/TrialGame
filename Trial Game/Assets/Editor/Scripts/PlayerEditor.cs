...
//    private List<PlayerManager.PlayerInfo> _playerInfos;
...
//        {
//            _playerManager.PlayerList = new Dictionary<Enums.Player, PlayerManager.PlayerInfo>();
//            _playerInfos = new List<PlayerManager.PlayerInfo>();
//        }
...
//        _reorderableList = new ReorderableList(_playerInfos, typeof(PlayerManager.PlayerInfo), true, true, true, true);
...
//    {
//        PlayerManager.PlayerInfo playerInfo = _playerManager.PlayerList[(Enums.Player)index];
...
//        player.Player = (Enums.Player)_playerManager.PlayerList.Count;
//        player.DeleteMoveSpace = false;
//        _playerManager.PlayerList.Add(player.Player, player);
//        _playerInfos.Add(_playerManager.PlayerList[player.Player]);
//    }
