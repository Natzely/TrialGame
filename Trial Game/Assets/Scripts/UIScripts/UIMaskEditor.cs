...
public class UIMaskEditor : UIObjectEditor
{
    ...
    protected override void EditObject()
    {
        if (!_mask.padding.Equals(_orderedPadding) || _mask.softness.Equals(SoftnessEdit))
        {
            ...
            {
                Vector4 newPadding = Vector4.MoveTowards(_mask.padding, _orderedPadding, _speed * Time.unscaledDeltaTime);
            ...
            {
                Vector2Int newSoftness = Vector2Int.CeilToInt(Vector2.MoveTowards(_mask.softness, SoftnessEdit, _speed * Time.unscaledDeltaTime));
